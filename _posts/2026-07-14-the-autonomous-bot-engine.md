...
After every race weekend on [apexclub.live](https://apexclub.live){:target="_blank"} I used to do the same three things by hand. Enter the starting grid, enter the final classifications, trigger the scoring calculation. Every step was a few clicks and a few minutes. The annoying part wasn't the time. It was the *kind* of work. It's detectable, it's repetitive, and getting it wrong silently corrupts a season's standings. So I wanted it gone, but only on my terms.
