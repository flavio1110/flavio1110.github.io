...
date: 2023-03-30T14:00:00+01:00
slug: embracing-my-lazyness-with-a-custom-git-cli
...
[got](https://github.com/flavio1110/got) is a CLI written in Go, created on top of the git CLI, to make my life easier by shortening some commands I use daily.
...
[<img src="https://imgs.xkcd.com/comics/automation_2x.png" alt="xckd 1319" />](https://xkcd.com/1319/)

> [xkcd](https://xkcd.com/1319/) Automation.
...
> Speaking on [zsh](https://ohmyz.sh/), if you use it with the `go` plugin, you will have a conflict with the alias `got` for `go test`.
...
Got is built using [cobra](https://github.com/spf13/cobra), which makes the work so much easier. Cobra has its own [CLI called Cobra Generator](https://github.com/spf13/cobra-cli/blob/main/README.md) that helps bootstrap your CLI project and add commands. You can check the full documentation [here](https://github.com/spf13/cobra-cli/blob/main/README.md), but here goes the basic usage:
...
The foundation for your CLI is in place, you _only_ need to worry about the actual logic of the commands because [cobra](https://github.com/spf13/cobra) will take care of all the pumbling for you.

You can check several examples in the [cobra](https://git,hub.com/spf13/cobra/blob/main/user_guide.md)[ documentation](https://git,hub.com/spf13/cobra/blob/main/user_guide.md), and use it as a base to create your shine CLI.

### Ok, what about the logic in got?

In got I have two ways of executing some logic. 1) using [go-git](https://github.com/go-git/go-git) to perform some actions like iterate in all local branches and delete all except main, and 2) executing a git cli command from my Go application directly.

#### go-git

> [go-git](https://github.com/go-git/go-git) is a highly extensible git implementation library written in pure Go. It can be used to manipulate git repositories at low level (plumbing) or high level (porcelain), through an idiomatic Go API. - (Description from its repo).
...
_The snippet below is part of the [`root.go`](https://github.com/flavio1110/got/blob/main/cmd/root.go)_
